    ...
    <div id="wrapper">
        ...
        <div class="content-page pt-2">
            <div class="content">
                ...
                <form action="/color/add-color/add" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-9">
                            <div class="card-box">
                                <h4 class="header-title">Add New Color</h4>
                                <p class="sub-header">
                                    ...
                                    <div class="col-12">
                                        <div class="p-2">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="colorName" id="simpleinput" class="form-control" placeholder="Color Name..." required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label" for="simpleinput">Color Code</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="colorCode" id="simpleinput" class="form-control" placeholder="Color Code...">
                                                </div>
                                            </div>
                                            <div class="form-group row">
