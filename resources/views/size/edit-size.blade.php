<?php
// All the information of this size is already store in $sizeDetails object
    ...
    <div id="wrapper">
        ...
        <div class="content-page pt-2">
            <div class="content">
                ...
                <form action="/size/edit-size/{{$sizeDetails["id"]}}/save" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-9">
                            <div class="card-box">
                                ...
                                <p class="sub-header">
                                    Please add <code>Size Name</code> and <code>Size Code</code> for every color.
                                </p>
                                    ...
                                    <div class="col-12">
                                        <div class="p-2">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="sizeName" id="simpleinput" class="form-control" value="{{$sizeDetails["size_name"]}}" placeholder="Size Name..." required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label" for="simpleinput">Color Code</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="sizeCode" id="simpleinput" class="form-control" value="{{$sizeDetails["size_code"]}}" placeholder="Size Code...">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <button type="submit" class="btn btn-success btn-rounded width-md waves-effect waves-light float-right w-fit-content">Edit Size</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
