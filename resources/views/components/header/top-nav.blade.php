...
?>
<!-- Topbar Start -->
<div class="navbar-custom bg-color-white border">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                ...
                <div class="slimscroll noti-scroll">
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item active d-none">
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button"
                aria-haspopup="false" aria-expanded="false">
                <img @if($userDetails->logo)  src="{{ $imageLoadingUrl . $userDetails->logo }}" @else  src="{{ asset('images/avatar-icon-png-1.jpg') }}" @endif alt="user-image"
                    class="rounded-circle">
                <span class="pro-user-name ml-1">
                    {{ $userDetails['shop_name'] }} <i class="mdi mdi-chevron-down"></i>
                </span>
            </a>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                <!-- item-->
                <a href="{{ route('show_profile_page') }}" class="dropdown-item notify-item">
                ...
                <!-- item-->
                <a href="{{ route('sign_out') }}" class="dropdown-item notify-item">
    ...
    <div class="logo-box border-bottom">
        <a href="/" class="logo logo-dark text-center">
            <span class="logo-lg">
                <img src="{{ asset('images/merchant-panel-logo.png') }}" alt="" height="50">
            </span>
            <span class="logo-sm">
