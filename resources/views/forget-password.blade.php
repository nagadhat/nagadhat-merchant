            ...
            <div class="container">
                ...
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        <h2 class="form-title">Getting an OTP</h2>
                        <form method="POST" class="register-form" id="login-form"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="mobile" id="mobile" placeholder="Enter Your Registered Mobile No." required/>
                            </div>
                            <div class="form-group form-button">
                                <input type="submit" class="form-submit" value="Get OTP" />
                            </div>
                        </form>
